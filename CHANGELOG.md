...
### Fixed
- Каталог сервисов: поиск, фильтр и страницы по 20 записей; ошибки загрузки больше не показывают устаревшие строки, а создание сервиса и новой декларации сохраняет черновик и блокирует поля на время запроса.
